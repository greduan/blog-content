...
A config tutorial, tour whatever will come later in another blog post.html, in the
...
If there's something you think could be said better in this post.html or you find a
typo feel free to [modify it](https://github.com/Greduan/eduantech.docpad/blob/master/src/render/post.htmls/the-world-of-window-managers.html.md)
