...
works quite well which can be found in this blog post.html: [From the mind of a nerd:
Font Configuration in Arch Linux][blog-post.html]

[blog-post.html]: http://jaysonrowe.blogspot.mx/2013/04/font-configuration-in-arch-linux.html
